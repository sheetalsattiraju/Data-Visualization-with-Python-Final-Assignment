...
#Plot 1 Automobile sales fluctuate over Recession Period (year wise)
        ...
        R_chart1 = dcc.Graph(figure=px.line(yearly_rec, x='Year', y='Automobile_Sales', title="Average Automobile Sales during Recession Period")
        )

#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        # use groupby to create relevant data for plotting
        average_vehicle = recession_data.groupby('Vehicle_Type')['Automobile_Sales'].mean().reset_index()                           
        R_chart2  = dcc.Graph(figure=px.bar(average_vehicle, x='Vehicle_Type', y='Automobile_Sales', title='Average Automobile Sales by vehicle type during Recession Period')
        )
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        R_chart4= dcc.Graph(
            figure=px.bar(unemp_data,
                ...
                y='Automobile_Sales',
                color='Vehicle_Type',
                title="Effect of Unemployment Rate on Automobile sales by Vehicle Type during Recession Period"))    
